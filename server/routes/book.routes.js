...
router.post('/post', authenticateWriter, controllers.postBook);
router.patch('/update', authenticateWriter, controllers.updateBook);
router.delete('/delete', authenticateWriter, controllers.deleteBook);
